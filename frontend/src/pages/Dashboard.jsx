    ...
    <div className={WRAPPER}>
      ...
      <div className={HEADER}>
        <div className="min-w-0">
          <h1 className="text-xl md:text-3xl font-bold text-grey-800 flex items-center gap-2">
            <HomeIcon className="text-purple-500 w-5 h-5 md:w-6 md:h-6 shrink-0" />
            <span className="truncate"> Task Overview</span>
          </h1>
          <p className="text-sm text-grey-500 mt-1 ml-7 truncate">
      ...
      <div className="space-y-6">
        ...
        rounded-xl hover:border-purple-400 bg-purple-50/50 cursor-pointer transition-colors">
          ...
          <span className="text-purple-600 font-medium">Add New Task</span>
        </div>
      </div>
