    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center justify-center p-4">
        ...
        shadow-lg relative p-6 animate-fadeIn">
            <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={onClose} className="p2 hover:bg-purple-100 rounded-lg
                transition-colors text-grey-500 hover:text-purple-700">
                    <X className="w-5 h-5" />
                </button> 
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" 
                       ...
                       className={baseControlClasses} placeholder="Add deatils about your task" />
                </div>
                ...
                font-medium py-2.5 rounded-lg flex items-center justify-center gap-2 disabled:opacity-50
