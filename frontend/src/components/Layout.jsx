...
const Layout = ({ onLogout, user}) => {
  ...
  const StateCard = ({ title, value, icon}) =>(
    <div className='p-2 sm:p-3 rounded-xl bg-white shadow-sm border border-purple-100 hover:shadow-md transition-all duration-300
          ...
          <div className='grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6'>
             ...
             <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
              <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
                <h3 className='text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-grey-800
                ...
                <div className='grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6'>
                  <StateCard title='Total Tasks' value={stats.totalCount} icon={<Circle className='w-3.5
                  h-3.5 sm:w-4 sm:h-4 text-purple-500'/>}/>
                  <StateCard title='Completed' value={stats.completedTasks} icon={<Circle className='w-3.5
                  h-3.5 sm:w-4 sm:h-4 text-green-500'/>}/>
                  <StateCard title='Pending' value={stats.pendingCount} icon={<Circle className='w-3.5
                  h-3.5 sm:w-4 sm:h-4 text-purple-500'/>}/>
                  <StateCard title='Completion Rate'  value={`${stats.completionPercentage}%`} icon={<Zap className='w-3.5
                  h-3.5 sm:w-4 sm:h-4 text-purple-500'/>}/>
                </div>
              ...
              <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
                <h3 className='text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-gray-800 flex item-center gap-2'>
