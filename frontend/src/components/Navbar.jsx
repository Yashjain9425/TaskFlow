...
const Navbar = ({user = {}, onLogout}) => {
  ...
  return (
    <header className='sticky top-0 z-50 bg-white/90 shadow-sm 
            ...
            <div className='flex items-center gap-2 cursor-pointer group'
                onClick={() => navigate('/')}>
                    ...
                    group-hover:scale-105 transition-all duration-300'>
                        ...
                        <div className='absolute -bottom-1 -middle-1 w-3 h-3 bg-white rounded-full shadow-md 
                        animate-ping'/>
                    </div>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <div ref={menuref} className="relative">
                        ...
                        py-2 rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300
                        ...
                        {menuOpen && (
                            ...
                            shadow-xl border borderpurple-100 z-50 overflow-hidden animate-fadeIn">
                                <li className="p-2">
                                    <button onClick={() => {
                                        setMenuOpen(false);
                                        navigate('/profile');
                                    ...
                                    text-grey-700 transition-colors flex items-center gap-2 group" role="menuitem">
